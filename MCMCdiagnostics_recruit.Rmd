---
 ...
 subtitle: "Test v3.0 - Ingrowth model accounting for ingrowth and mortality of new individuals with plot random effect on ingrowth rate `m`"
 author: "Will Vieira"
...
for(Sp in spIds)
{
  ...
  val_sp <- val_sp[
    ...
    .(plot_id, plot_id_seq, species_id, nbRecruit, deltaYear_plot, plot_size)
  ]
  ...
  # compute m plot specific parameter
  val_sp[,
    m := exp(mPop_log + mPlot_log)
  ]
