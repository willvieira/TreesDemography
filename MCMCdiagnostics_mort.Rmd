...
## Mortality in function of basal area competition

```{r plot_preds,echo=FALSE,warning=FALSE,message=FALSE,fig.height=6,fig.width=12}
...
for(Sp in spIds)
{
  ...
  yLim = range(dt_p1$value, dt_p2$value)
