...
```{r temp_pred,echo=FALSE,fig.height = 8, fig.width = 10}
post |>
...
```{r prec_pred,echo=FALSE,fig.height = 8, fig.width = 10}
post |>
...
# Prediction figures
  ...
  dt_p4 <- train_sp |>
    select(iter2, bio_01_mean, mort, mort_pred) |>
    mutate(
      tempc = cut(
        bio_01_mean,
  ...
  dt_p5 <- train_sp |>
    select(iter2, bio_12_mean, mort, mort_pred) |>
    mutate(
      precc = cut(
        bio_12_mean,
