---
 ...
 subtitle: "Model: intercept + plot random effects + size"
 author: "Will Vieira"
...
```{r SizeEffect,echo=FALSE,warning=FALSE,message=FALSE,fig.height=6,fig.width=10}
post |>
...
```{r crossValidation, echo=FALSE, warning=FALSE, message=FALSE, fig.height=4,fig.width=5}
