---
 ...
 subtitle: "Test v3.0 - size ingrowth in function of delta time"
 author: "Will Vieira"
...
#     mutate(
#       value = case_when(
#         par == 'size_int' ~ rnorm(nIter, log(127), 1),
#         par == 'phi_time' ~ rnorm(nIter, 2, 1),
#         par == 'sigma_size' ~ rnorm(nIter, 0, 1)
#       )
#     )
#   )
...
for(Sp in spIds)
{
  ...
  train_sp[,
    ingrow_size := qnorm(runif(.N, pnorm(127, ingrow_mean, sigma_size)), ingrow_mean, sigma_size)
  ]
