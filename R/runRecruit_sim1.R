...
dir.create('output')
saveRDS(out_sample, file = paste0('output/out_sim1', sp, '_', simName, '.RDS'))


pdf(file = paste0('output/plot_sim1', sp, '_', simName, '.pdf'), width = 9.3, height = 16.2)
traceplot(
    out_sample,
