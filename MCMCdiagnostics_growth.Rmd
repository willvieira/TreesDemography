---
 ...
 subtitle: "Test v17.9.0 - Von Bertalanffy model - r in function of `BA_comp_sp`, `BA_comp_intra` with plot and individual random effects"
 author: "Will Vieira"
...
treeData[, .(species_id, dbh, deltaTime, BA_comp_sp, BA_comp_intra, sampled2)] |>
  mutate(sample = sampled2) |>
  pivot_longer(
    cols = c(dbh, deltaTime, BA_comp_sp, BA_comp_intra),
    names_to = 'var'
  ) |>
...
## Growth in function of Basal area
