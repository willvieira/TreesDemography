...
# Plot predictions
  ...
  growth_model <- function(param, sim, newdata, indVar = FALSE)
  {
    ...
    if(!indVar)
    {
      ...
      lower <- qgamma(.95, (mu_d^2/param["sigma_base"])*means, mu_d/param["sigma_base"], lower.tail = FALSE)
      upper <- qgamma(.95, (mu_d^2/param["sigma_base"])*means, mu_d/param["sigma_base"])
