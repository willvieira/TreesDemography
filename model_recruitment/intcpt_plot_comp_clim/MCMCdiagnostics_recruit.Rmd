...
```{r crossValidation, echo=FALSE, warning=FALSE, message=FALSE, fig.height=7,fig.width=10}
...
for(Sp in spIds)
{
  ...
  p1 <- val_sp[
    ...
    ggplot() +
    aes(BAsp_cut, log(value + 1), fill = sim) +
    geom_boxplot() +
    labs(
      x = 'Conspecific basal area',
  ...
  p2 <- val_sp[
    ...
    ggplot() +
    aes(BA_cut, log(value + 1), fill = sim) +
    geom_boxplot() +
    labs(
      x = 'Total basal area',
      y = 'Number of recruitment',
  ...
  p3 <- val_sp[
    ...
    ggplot() +
    aes(temp_cut, log(value + 1), fill = sim) +
    geom_boxplot() +
    labs(
      x = 'Mean annual temperature',
      y = 'Number of recruitment',
  ...
  p4 <- val_sp[
    ...
    ggplot() +
    aes(prec_cut, log(value + 1), fill = sim) +
    geom_boxplot() +
    labs(
      x = 'Mean annual precipitation',
      y = 'Number of recruitment',
